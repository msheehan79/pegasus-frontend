...
class Settings : public QObject {
    ...
    Q_PROPERTY(bool showMissingFiles
               READ showMissingFiles WRITE setShowMissingFiles
               NOTIFY showMissingFilesChanged)
...
public:
    ...
    bool showMissingFiles() const { return AppSettings::general.show_missing_files; }
    void setShowMissingFiles(bool);
