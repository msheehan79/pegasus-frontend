...
#define GETTER(type, name, field) \
    ...
    GETTER(bool, isCompleted, is_completed)
    GETTER(bool, getFileExists, fileExists)
...
#undef GEN
    ...
    Q_PROPERTY(bool fileExists READ getFileExists WRITE setFileExists NOTIFY fileExistsChanged)
