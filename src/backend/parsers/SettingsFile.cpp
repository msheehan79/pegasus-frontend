...
ConfigEntryMaps::ConfigEntryMaps()
    ...
    , str_to_general_opt {
        ...
        { QStringLiteral("show-missing-files"), GeneralOption::SHOW_MISSING_FILES },
    ...
    switch (option_it->second) {
        ...
        case ConfigEntryGeneralOption::VERIFY_FILES:
            if (!store_bool_maybe(val, AppSettings::general.verify_files))
                log_needs_bool(lineno, key);
            break;
        case ConfigEntryGeneralOption::SHOW_MISSING_FILES:
            if (!store_bool_maybe(val, AppSettings::general.show_missing_files))
                log_needs_bool(lineno, key);
            break;
...
void SaveContext::print_general(QTextStream& stream) const
{
    ...
    GeneralStrMap option_values {
        ...
        { GeneralOption::SHOW_MISSING_FILES, AppSettings::general.show_missing_files ? STR_TRUE : STR_FALSE },
